...
def spherical_midpoint_from_cartesian(a, b):
    spherical1 = cartesian_to_spherical(a[0], a[1], a[2])
    spherical2 = cartesian_to_spherical(b[0], b[1], b[2])

    m = spherical_midpoint(spherical1, spherical2)
